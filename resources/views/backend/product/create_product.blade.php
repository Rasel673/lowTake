                    ...
                    <div class="col-sm-6 d-flex">
                        ...
                        <div class="form-group mr-1">
                            <div class="form-check">
                              <input class="form-check-input"  name="popular" value="1" type="checkbox">
                          ...
                          <div class="form-group mr-1">
                            <div class="form-check">
                              <input class="form-check-input"  name="islamic" value="1" type="checkbox">
                          ...
                          <div class="form-group mr-1">
                            <div class="form-check">
                              <input class="form-check-input"  name="children" value="1" type="checkbox">
                          ...
                          <div class="form-group ">
                            <div class="form-check">
                              <input class="form-check-input"  name="novels" value="1" type="checkbox">
